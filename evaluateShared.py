...
class Load:
    ...
    def print(self):
        print(f"Load {self.id} pickup {self.pickup.toList()}, dropoff {self.dropoff.toList()}")
...
class VRP:
    ...
    def loadsToList(self):
        return [[load.pickup.toList(), load.dropoff.toList()] for load in self.loads]
